...
// void mpc::publishVel(double angleCommand,double speedCommand)
// {
//     geometry_msgs::Twist msg;

//     msg.linear.x=speedCommand;
//     msg.angular.z=angleCommand;
//     //msg.angular.z=atan2(0.18*angleCommand,speedCommand);

//     pubMessage.publish(msg);
// }

// void mpc::publishVel(double angleCommand,double speedCommand,double a)
// {
//     geometry_msgs::Twist msg;
...
//     if(msg.angular.z>0.9){msg.angular.z=0.9;}
//     //if(msg.linear.x<0.01){msg.linear.x=0.6;}
//     ROS_ERROR("msg.linear.x=%f",msg.linear.x);
//     ROS_ERROR("msg.angular.z=%f",msg.angular.z);
