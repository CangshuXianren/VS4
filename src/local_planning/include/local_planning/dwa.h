...
public:
    ...
    bool CollisionCheck(const vector<CarState> &trajectory, const CarState &carstate, const AstarPathFinder* tmpmap, int mode, int id); // mode=0,static map; mode=1, static map and dynamic obstacle
