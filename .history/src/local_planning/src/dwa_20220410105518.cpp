...
void DWA::FLPathCallback(const custom_messages::vehicle_status::ConstPtr& path_msg){
    FLtarget.xPos = path_msg->xPos;
    FLtarget.yPos = path_msg->yPos;
}
...
int main(int argc, char** argv){
    ...
    ros::Subscriber FLpath_sub = n.subscribe("/No_0/myodom", 1, &DWA::FLPathCallback, mydwa);
    ...
    if(!ID){
        ...
        ros::Subscriber path_sub = n.subscribe("/No_0/myodom", 1, &DWA::FLPathCallback, mydwa);
