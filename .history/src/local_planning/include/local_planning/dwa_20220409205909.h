...
public:
    ...
    void FLPathCallback(const custom_messages::vehicle_status::ConstPtr& path_msg);
    ...
    double calc_obstacle_cost(const vector<CarState> &trajectory, const CarState &carstate, const AstarPathFinder* tmpmap);
    ...
    CarState myend;
    nav_msgs::Path ends;
    custom_messages::vehicle_status FLtarget;
