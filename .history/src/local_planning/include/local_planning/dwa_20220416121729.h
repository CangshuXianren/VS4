...
public:
    ...
    double calc_obstacle_cost(const vector<CarState> &trajectory, const CarState &carstate, const AstarPathFinder* tmpmap, int mode); // mode=0,static map; mode=1, static map and dynamic obstacle
